      ...
      <div>
        <Sidebar >
          ...
          <Routes>
            ...
            <Route path='/titel' element={<ActivityLayout><Titel /></ActivityLayout>} />
            <Route path='/duration' element={<ActivityLayout><Duration /></ActivityLayout>} />
            <Route path='/categories' element={<ActivityLayout><Categories /></ActivityLayout>} />
            <Route path='/location' element={<ActivityLayout><Location /></ActivityLayout>} />
            <Route path='/description' element={<ActivityLayout><Description /></ActivityLayout>} />
            <Route path='/photos' element={<ActivityLayout><Photos /></ActivityLayout>} />
            <Route path='/videos' element={<ActivityLayout><Videos /></ActivityLayout>} />
            <Route path='/inclusions' element={<ActivityLayout><Inclusions /></ActivityLayout>} />
            <Route path='/exclusions' element={<ActivityLayout><Exclusions /></ActivityLayout>} />
            <Route path='/timeDatePass' element={<ActivityLayout><TimeDatePass /></ActivityLayout>} />
            <Route path='/openingHours' element={<ActivityLayout><OpeningHours /></ActivityLayout>} />
            <Route path='/bookingCutoff' element={<ActivityLayout><BookingCutoff /></ActivityLayout>} />
            <Route path='/bookingOpeningDate' element={<ActivityLayout><BookingOpeningDate /></ActivityLayout>} />
            <Route path='/capacity' element={<ActivityLayout><Capacity /></ActivityLayout>} />
            <Route path='/startTime' element={<ActivityLayout><StartTime /></ActivityLayout>} />
            <Route path='/pricingCategories' element={<ActivityLayout><PricingCategories /></ActivityLayout>} />
            <Route path='/rates' element={<ActivityLayout><Rates /></ActivityLayout>} />
            <Route path='/pricing' element={<ActivityLayout><Pricing /></ActivityLayout>} />
            <Route path='/meetingPickup' element={<ActivityLayout><MeetingPickup /></ActivityLayout>} />
            <Route path='/meetingPoint' element={<ActivityLayout><MeetingPoint /></ActivityLayout>} />
          </Routes>
        </Sidebar>
