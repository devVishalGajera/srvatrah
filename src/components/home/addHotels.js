...
const AddHotels = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await fetch(`http://127.0.0.1:3232/inventries/hotel`, {
        method: 'POST',
        headers: {
      ...
      <div className="card" style={{ margin: '15px', padding: '15px' }}>
          ...
          <div className="live-preview">
            <div className="row g-3">
              <div className="col-sm-4">
                <label for="firstNameinput" className="form-label">Hotel Type</label>
                <Autocomplete
                  ...
                  onChange={(e, selectedOption) => handleAutocompleteChange('hotelType', selectedOption)}
                />
              </div>
              <div className="col-sm-4">
                <label for="firstNameinput" className="form-label">Hotel Name</label>
                <input
                  required
                  type="name"
              ...
              <div className="col-sm-4">
                <label for="firstNameinput" className="form-label">Address</label>
                <textarea
                  className="form-control"
                  rows="3"
              ...
              <div className="col-sm-4">
                <label for="firstNameinput" className="form-label">Select State</label>
                <Autocomplete
                  id="country-select-demo"
                  sx={{ width: "100%" }}
                  size='small'
                  ...
                  onChange={(e, selectedOption) => handleAutocompleteChange('state', selectedOption)}
                />


              </div>
              <div className="col-sm-4">
                <label for="firstNameinput" className="form-label">Select City</label>
                <Autocomplete
                  id="country-select-demo"
                  sx={{ width: "100%" }}
                  size='small'
                  ...
                  onChange={(e, selectedOption) => handleAutocompleteChange('city', selectedOption)}
                />
              </div>
              <div className="col-sm-4">
                <label for="firstNameinput" className="form-label">Pincode</label>
                <input
                  type="number"
                  className="form-control"
                  placeholder="Pincode"
              ...
              <div className="col-sm-4">
                <label for="firstNameinput" className="form-label">Contact Number</label>
                <input
                  type="number"
                  className="form-control"
              ...
              <div className="col-sm-4">
                <label for="firstNameinput" className="form-label">Email Address</label>
                <input
                  type="email"
                  className="form-control"
              ...
              <div className="col-sm-4">
                <label for="firstNameinput" className="form-label">Contact Person</label>
                <input
                  type="text"
                  className="form-control"
              ...
              <div className="col-sm-4">
                <label for="firstNameinput" className="form-label">Description</label>
                <textarea
                  className="form-control"
                  id=""
                  rows="3"
        ...
        <div>
          {rooms.map((room, index) => (
            <div key={index} style={{ marginBottom: '20px' }}>
              <div className="card-header align-items-center d-flex" style={{ borderTop: '1px solid #e9ebec' }}>
                <h1 className="card-title  flex-grow-1 " style={{ marginBottom: '0px' }}>Room Type</h1>
              </div>
              <div className="card-body">
                <div className="live-preview">
                  <div className="row g-3">
                    <div className="col-sm-4">
                      <label htmlFor={`roomTypeInput-${index}`} className="form-label">Room Type</label>
                      <Autocomplete
                        ...
                        autoHighlight
                        value={room.roomType}
                        onChange={(e, newValue) => handleRoomChange(index, 'roomType', newValue)}
                        required
                    ...
                    <div className="col-sm-4">
                      <label htmlFor={`inventoryInput-${index}`} className="form-label">Inventry</label>
                      <input
                        type="number"
                        className="form-control"
                    ...
                    <div className="col-sm-4">
                      <label htmlFor={`occupancy1Input-${index}`} className="form-label">Occupancy-1</label>
                      <input
                        type="number"
                        className="form-control"
                        placeholder="Rate"
                        aria-label="contact-person"
                        value={room.occupancyRates[0] === 0 ? '' : room.occupancyRates[0]}
                        onChange={(e) => handleRoomChange(index, 'occupancyRates', [e.target.value, room.occupancyRates[1], room.occupancyRates[2]])} />
                    </div>
                    <div className="col-sm-4">
                      <label htmlFor={`occupancy2Input-${index}`} className="form-label">Occupancy-2</label>
                      <input
                        type="number"
                        className="form-control"
                        placeholder="Rate"
                        aria-label="contact-person"
                        value={room.occupancyRates[1] === 0 ? '' : room.occupancyRates[1]}
                        onChange={(e) => handleRoomChange(index, 'occupancyRates', [room.occupancyRates[0], e.target.value, room.occupancyRates[2]])}
                      />
                    </div>
                    <div className="col-sm-4">
                      <label htmlFor={`occupancy3Input-${index}`} className="form-label">Occupancy-3</label>
                      <input
                        type="number"
                        className="form-control"
                        placeholder="Rate"
                        aria-label="contact-person"
                        value={room.occupancyRates[2] === 0 ? '' : room.occupancyRates[2]}
                        onChange={(e) => handleRoomChange(index, 'occupancyRates', [room.occupancyRates[0], room.occupancyRates[1], e.target.value])}
                      // onChange={(e) => handleInputChange('contactPerson', e.target.value)}
                      />
                    </div>
                    <div className="col-sm-4">
                      <label htmlFor={`childWithBedInput-${index}`} className="form-label">Child-WithBedPrice</label>
                      <input
                        type="number"
                        className="form-control"
                        placeholder="Rate"
                        aria-label="contact-person"
                        value={room.childWithBedPrice === 0 ? '' : room.childWithBedPrice}
                        onChange={(e) => handleRoomChange(index, 'childWithBedPrice', e.target.value)}
                      // onChange={(e) => handleInputChange('contactPerson', e.target.value)}
                      />
                    </div>
                    <div className="col-sm-4">
                      <label htmlFor={`childWithoutBedInput-${index}`} className="form-label">Child-WithoutBedPrice</label>
                      <input
                        type="text"
                        className="form-control"
                        placeholder="Rate"
                        aria-label="contact-person"
                        value={room.childWithoutBedPrice === 0 ? '' : room.childWithoutBedPrice}
                        onChange={(e) => handleRoomChange(index, 'childWithoutBedPrice', e.target.value)}
                      // onChange={(e) => handleInputChange('contactPerson', e.target.value)}
                      />
                    </div>
                    <div className="col-sm-4">
                      <label htmlFor={`amenitiesInput-${index}`} className="form-label">Amenities</label>
                      <Autocomplete
                        multiple
                        ...
                        onChange={(e, newValue) => handleRoomChange(index, 'amenities', newValue)}
              ...
              <div style={{ display: 'flex', alignItems: 'end', justifyContent: 'center' }}>
                {index >= rooms.length - 2 && ( // Show "Remove Room" button only for the last 2 forms
                  <button onClick={() => removeRoom(index)} className="form-label btn btn-danger btn-border" style={{ marginBottom: '0px' }}>
                    Remove Room
                  </button>
                )}
              </div>
          ...
          <div style={{ display: 'flex', alignItems: 'end', justifyContent: 'center' }}>
            {rooms.length < 3 && ( // Show "Add Room" button only if there are less than 3 forms
              <button onClick={addRoom} className="form-label btn btn-primary btn-border" style={{ marginBottom: '0px' }}>
                Add Room
              </button>
            )}
          </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'end', padding: '15px', borderTop: '1px solid #f1f1f1' }}>
          <button class="btn btn-primary btn-border" onClick={handleSubmit}>submit</button>
        </div>
      </div>
    </div>
  )
