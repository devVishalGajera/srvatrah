    ...
    const handleSubmit = async () => {
        try {
            const promises = vehicles.map(async (vehicle, index) => {
                ...
                const url = `http://127.0.0.1:3232/inventries/vehicle?${queryString}`;
                                ...
                                <div className="live-preview">
                                    <div className="row g-3">
                                        <div className="col-sm-4">
                                            <label htmlFor={`vehicleTypeInput-${index}`} className="form-label">Season Type</label>
                                            <Autocomplete
                                        ...
                                        <div className="col-sm-4">
                                            <label htmlFor={`modelNameInput-${index}`} className="form-label">Seasonality Name</label>
                                            <input
                                                type="text"
                                        ...
                                        <div className="col-sm-4">
                                            <label htmlFor={`modelNameInput-${index}`} className="form-label">Increase</label>
                                            <input
                                                type="text"
                                                className="form-control"
                                        ...
                                        <div className="col-sm-4">
                                            <label htmlFor={`modelNameInput-${index}`} className="form-label">Decrease</label>
                                            <input
                                                type="text"
                                                className="form-control"
                                        ...
                                        <div className="col-sm-4">
                                            <label className="form-label">Availability Date From</label>
                                        ...
                                        <div className="col-sm-4">
                                            <label htmlFor={`statusInput-${index}`} className="form-label">Status</label>
                                            <FormControlLabel
                                                control={<Switch checked={vehicle.status} onChange={(e) => handleInputChange(index, 'status', e.target.checked)} />}
