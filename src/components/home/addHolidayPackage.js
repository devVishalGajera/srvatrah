                ...
                <div >
                    ...
                    <div className="card-body">
                        ...
                        <div className="row g-3">
                            <div className="col-sm-4">
                                <label for="firstNameinput" className="form-label">Select Type</label>
                                <Autocomplete
                                    ...
                                    renderInput={(params) => (
                                        <TextField
                                            ...
                                            onChange={(e) => handlePackageChange('selectType', e.target.value)}
                                        />
                                    )}
                                    onChange={(e, selectedOption) => handleAutocompleteChange('selectType', selectedOption)}
                                />
                            </div>
                            <div className="col-sm-4">
                                <label htmlFor="packageNameInput" className="form-label">Unique Id</label>
                                <input
                                    type="text"
                            ...
                            <div className="col-sm-4">
                                <label for="firstNameinput" className="form-label">Package Type</label>
                                <Autocomplete
                                    id="country-select-demo"
                                    sx={{ width: "100%" }}
                                    size='small'
                                    ...
                                    onChange={(e, selectedOption) => handleAutocompleteChange('packageType', selectedOption)}
                                />
                            </div>
                            <div className="col-sm-4">
                            ...
                            <div className="col-sm-4">
                                <label htmlFor="packageNameInput" className="form-label">Destination City</label>
                                <input
                                    type="text"
                                    className="form-control"
                                    placeholder="Destination City"
                                    onChange={(e) => handlePackageChange('destinationCity', e.target.value)}
                                />
                            </div>
                            <div className="col-sm-4">
                                <label htmlFor="packageDurationDaysInput" className="form-label">No of Days</label>
                                <input
                                    type="number"
                                    className="form-control"
                                    placeholder="Days"
                            ...
                            <div className="col-sm-4">
                                <label htmlFor="packageDurationNightsInput" className="form-label">No of Nights</label>
                                <input
                                    type="number"
                                    className="form-control"
                                    placeholder="Nights"
                            ...
                            <div className="col-sm-4">
                                <label for="firstNameinput" className="form-label">Banner Image</label>
                                <input
                                    type="file"
                                    className="form-control"
                                    id="imagesInput"
                            ...
                            <div className="col-sm-4">
                                ...
                                <textarea
                                    className="form-control"
                                    rows="3"
                                    onChange={(e) => handlePackageChange('highlight', e.target.value)}
                                ></textarea>
                            </div>
                            <div className="col-sm-4">
                                <label htmlFor={`highlightInput`} className="form-label">Includes</label>
                                <textarea
                                    className="form-control"
                                    rows="3"
                                    onChange={(e) => handlePackageChange('includes', e.target.value)}
                                ></textarea>
                            </div>
                            <div className="col-sm-4">
                                <label htmlFor={`highlightInput`} className="form-label">Excludes</label>
                                <textarea
                                    className="form-control"
                                    rows="3"
                                    onChange={(e) => handlePackageChange('excludes', e.target.value)}
                                ></textarea>
                            </div>
                            <div className="col-sm-4">
                            ...
                            <div className="col-sm-4">
                                <label htmlFor="recommendedPackageSwitch" className="form-label">
                                    Recommended Package
                                </label>
                                <FormControlLabel
                                    control={
                    ...
                    <div className="card-body">
                        <div className="live-preview">
                            <div className="row g-3">
                                <div className="">
                                    <label htmlFor="availableVehicleInput" className="form-label">Vehicle Prices</label>
                                        ...
                                        <div key={index} style={{ display: 'flex', marginBottom: "10px" }} className="row g-3">
                                            ...
                                            <div className='col-sm-4'>
                                                <input
                                                    ...
                                                    value={vehicle.price}
                                                    onChange={(e) => handleNestedInputChange('vehiclePrices', index, 'price', e.target.value)}
                                                />
                                            </div>
                                            <div className='col-sm-4'>
