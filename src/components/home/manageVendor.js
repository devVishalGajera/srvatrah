                            ...
                            <div className="card-body">
                                <div className="live-preview">
                                    <div className="row g-3">
                                        ...
                                        <div className="col-sm-4">
                                            <label htmlFor={`modelNameInput-${index}`} className="form-label">Vendor Name</label>
                                            <input
                                                type="text"
                                        ...
                                        <div className="col-sm-4">
                                            <label htmlFor={`brandNameInput-${index}`} className="form-label">percentage (%)</label>
                                            <input
                                                type="text"
                                                className="form-control"
                                        ...
                                        <div className="col-sm-4">
                                            <label for="firstNameinput" className="form-label">Vendor Images</label>
                                            <input
                                                type="file"
                                                className="form-control"
                                                id="imagesInput"
