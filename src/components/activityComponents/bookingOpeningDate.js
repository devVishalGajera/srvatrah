import { Button, Checkbox, FormControl, FormControlLabel, FormGroup, Radio, RadioGroup, Switch, TextField } from '@mui/material';
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '20px' }}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '20px', marginBottom: '30px' }}>
                ...
                <p style={{ padding: '5px', textAlign: 'center' }}>
                    Do you have an event or an offer where ticket sales need to start at a specific time? Do you need to fix how early your travellers can book your experiences? If yes, then Booking opening date is the setting for you.
                </p>
            </div>
            ...
            <div style={{ width: '70%' }}>
                ...
                <FormControl style={{ width: '100%' }}>
                    ...
                    >
                        <div style={{ border: '1px solid #DEE3EA', borderRadius: '7px', padding: '30px', height: '100px', display: 'flex', alignItems: 'center', marginTop: '10px' }}>
                ...
                <div style={{ marginTop: '20px' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        <h6 style={{paddingLeft:'15px'}}>At what time will it be possible to book?</h6>
                    </div>
                </div>

                <div style={{ marginTop: '20px' }}>
                    <h5>Select the relative month(s) and set time to open for bookings.</h5>
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                        <TextField
                            style={{ width: '100px' }}
                            id="outlined-number"
