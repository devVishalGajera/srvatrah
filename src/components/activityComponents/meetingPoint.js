...
const rows = [
    createData('mota-varaccha', "mota-varacha", "Edit/Delete")
];
        ...
        <>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '20px' }}>
                ...
                <div style={{ width: '70%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                        ...
                        <Table sx={{ minWidth: 650 }} aria-label="simple table">
                            <TableHead>
                                <TableRow>
                                    ...
                                    <TableCell sx={{ width: '250px' }} align="left">Address</TableCell>
                    ...
                    <Button onClick={handleOpen} style={{ marginTop: '10px' }} variant="contained">+ Add Start Point</Button>
