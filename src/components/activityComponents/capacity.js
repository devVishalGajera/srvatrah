    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '20px' }}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '20px', marginBottom: '30px' }}>
                ...
                <p style={{ padding: '5px' }}>
                Do you have a maximum number of travellers per departure, or do you review and approve each booking individually?
                </p>
            </div>
                    ...
                    >
                        <div style={{ border: '1px solid #DEE3EA',borderRadius:'7px', padding: '55px', height: '100px', display: 'flex', alignItems: 'center',marginTop:'10px' }}>
                            ...
                            <div>
                                ...
                                <span>There is no limit. Confirm as many bookings as possible.</span>
                            </div>
                        </div>
                        <div style={{ border: '1px solid #DEE3EA',borderRadius:'7px', padding: '55px', height: '100px', display: 'flex', alignItems: 'center',marginTop:'10px' }}>
                            ...
                            <div>
                                ...
                                <span>I have limited capacity. Bookings should only be confirmed as long as there are seats remaining.</span>
                            </div>
                        </div>
                        <div style={{ border: '1px solid #DEE3EA',borderRadius:'7px', padding: '55px', height: '100px', display: 'flex', alignItems: 'center',marginTop:'10px' }}>
                            ...
                            <div>
                                ...
                                <span>Bookings cannot be confirmed immediately. The customer waits until I manually confirm or reject their booking request.</span>
                            </div>
                        </div>
                    </RadioGroup>
                </FormControl>
